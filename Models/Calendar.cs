...
/**
 * The model classes are used when parsing the JSON response from the API.
 * The values of the json are mapped to the properties of these model classes.
 */
...
public class Race
{
    ...
    // Commenting this out because I get an error when parsing the 2015 Truck Series calendar.
    // I don't have time to figure out what's going wrong so I'm commenting it out for now.
    //
